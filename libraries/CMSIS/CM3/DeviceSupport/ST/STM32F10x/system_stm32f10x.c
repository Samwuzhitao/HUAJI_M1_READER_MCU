...
*******************************************************************************/
  ...
  uint32_t SystemCoreClock         = (HSI_VALUE / 2) * 16 ;        /*!< System Clock Frequency (Core Clock) */
#endif
...
static void SetSysClockTo72(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    // RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL9);
		RCC->CFGR |= (uint32_t)(RCC_PLLSource_HSE_Div2 | RCC_CFGR_PLLMULL8);
#endif /* STM32F10X_CL */
